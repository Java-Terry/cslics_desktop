...
def main():
    fps = 10
    source_folder = '/home/java/Java/data/cslics_desktop_data/202312_Dec_cslics_desktop_sample_images'
    dest_folder = '/home/java/Java/data/cslics_desktop_data/202312_Dec_cslics_desktop_sample_images/videos'
    ...
    for filename in os.listdir(source_folder):
        if filename.endswith(('.mp4', '.avi', '.mov', '.MP4')):  # Check if file is a video file
            ...
            extract_frames(video_path, dest_folder, fps)
